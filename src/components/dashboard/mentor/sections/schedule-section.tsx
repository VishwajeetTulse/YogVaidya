...
const timeSlotSchema = z.object({
  ...
  sessionLink: z
    .string()
    .url("Please enter a valid session link")
    .min(1, "Session link is required"),
  notes: z.string(),
});
...
export const ScheduleSection = () => {
  ...
  useEffect(() => {
    const initializeSessionType = async () => {
      ...
      const sessionType =
        fetchedMentorType === "YOGAMENTOR"
          ? "YOGA"
          : fetchedMentorType === "DIETPLANNER"
            ? "DIET"
            : "MEDITATION";
  ...
  const onSubscriptionSubmit = async (data: SubscriptionSessionFormData) => {
    ...
    try {
      ...
      if (result.success) {
        toast.success(
          `Subscription session created! Scheduled for ${result.data.eligibleUsers} users`
        );
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        <TabsList
          className={`grid w-full ${mentorType === "DIETPLANNER" ? "grid-cols-1" : "grid-cols-2"}`}
        >
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        ...
                        <div className="space-y-1 leading-none">
                          <FormLabel>Recurring Time Slot</FormLabel>
                ...
                <div className="space-y-4">
                  {timeSlots
                    ...
                    .map((slot) => {
                      ...
                      const _isUpcoming = startTime > new Date();
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-gray-600 mt-2">
                  Create a session that will be automatically scheduled for all active users with
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Session Link *</FormLabel>
                          <FormControl>
                            <Input placeholder="https://zoom.us/j/your-meeting-link" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
                                <div className="space-y-1">
                                  <div className="flex items-center gap-1">
                                    ...
                                    at{" "}
                                    {new Date(session.scheduledTime).toLocaleTimeString("en-US", {
                                      hour: "numeric",
                                      minute: "2-digit",
                                      hour12: true,
                                    })}
