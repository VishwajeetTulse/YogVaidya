...
export const SubscriptionPrompt = ({
  ...
  const getStatusMessage = () => {
    ...
    if (isCancelledButActive && nextBillingDate) {
      ...
      return `Your subscription has been cancelled but you still have access until ${billingDate.toLocaleDateString(
        "en-US",
        {
          month: "long",
          day: "numeric",
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-8 text-center bg-gradient-to-br from-purple-50 to-pink-50 border-purple-200">
        ...
        <p className="text-gray-600 mb-6 max-w-lg mx-auto">{getStatusMessage()}</p>
