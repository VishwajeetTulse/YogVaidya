...
const MentorCardCompact: React.FC<{ mentor: MentorCardCompactProps }> = ({
  mentor,
}) => {
        ...
        <div className="flex items-start space-x-3 mb-3">
          <div className="relative">
            <Avatar className={cn(
              ...
              isActuallyAvailable ? "ring-2 ring-green-400 ring-offset-1" : "ring-2 ring-gray-300 ring-offset-1"
            )}>
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-gray-600 mb-1">
              {getMentorTypeLabel(mentor.mentorType)}
            </p>
