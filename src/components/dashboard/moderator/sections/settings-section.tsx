...
export const SettingsSection = ({ userDetails }: ModeratorSectionProps) => {
  ...
  const [isSaving, setIsSaving] = useState(false);  const [settings, setSettings] = useState<ModeratorSettings>({
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">Customize your moderator dashboard preferences.</p>
      </div>
