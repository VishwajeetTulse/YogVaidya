  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-24 relative" id="services">
      ...
      <div className="absolute bottom-10 left-10 opacity-20">
        <div className="w-32 h-32 rounded-full bg-pink-200" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
        ...
        <div className="transform transition-transform hover:-translate-y-2 duration-300">
          <ServiceCard
            ...
            bulletsItems={["One-on-one coaching", "Real-time feedback", "Personalized routines"]}
          />
        </div>
        ...
        <div className="transform transition-transform hover:-translate-y-2 duration-300">
          <ServiceCard
            ...
            bulletsItems={["Custom meal plans", "Ayurvedic principles", "Nutritional counseling"]}
          />
        </div>
        ...
        <div className="transform transition-transform hover:-translate-y-2 duration-300">
          <ServiceCard
            ...
            bulletsItems={["Mindfulness techniques", "Guided sessions", "Stress reduction"]}
          />
        </div>
      </div>
    </section>
