...
const MentorCard: React.FC<{ mentor: EnhancedMentorProps; colorClass: string }> = ({
  ...
  return (
    <Card className={cn(
      ...
      {!mentor.available && (
        <div className="absolute inset-0 bg-gray-900/10 z-5 pointer-events-none"></div>
      )}
          ...
          <div className="flex md:flex-col items-center md:items-center mb-4 md:mb-0 md:mr-3 md:w-24 flex-shrink-0">
            <div className="relative mr-3 md:mr-0 md:mb-2">
              <Avatar className={cn(
                ...
                mentor.available ? "ring-2 ring-green-400 ring-offset-1" : "ring-2 ring-gray-300 ring-offset-1"
              )}>
                <AvatarImage src={mentor.imageUrl} alt={mentor.name} />
                <AvatarFallback className={cn("text-white text-sm md:text-sm font-semibold", colorClass)}>
            ...
            <div className="flex-1 md:flex-none md:text-center">
              <h3 className="font-bold text-base md:text-sm text-gray-900 mb-1 md:mb-0.5">{mentor.name}</h3>
              <p className="text-sm md:text-xs text-gray-600 font-medium md:mb-1">{mentor.specialty}</p>
            ...
            <div className="space-y-2 md:space-y-1.5">
              ...
              <div className="flex flex-row md:flex-row gap-2 md:gap-2 items-center md:justify-between">
                ...
                <div className="flex items-center flex-1 md:flex-none">
                  <Award className={cn("w-3 h-3 md:w-3 md:h-3 mr-1", colorClass.replace('bg-', 'text-'))} />
                ...
                <div className="flex justify-end md:justify-end">
                  <Badge variant="outline" className="text-xs md:text-xs px-1.5 py-0.5 md:px-1.5 md:py-0.5">
              ...
              {mentor.certifications && (
                <div className="hidden md:block">
                  <p className="text-xs text-gray-600 italic">
                    <span className="font-medium">Cert:</span> {mentor.certifications.length > 45 
    ...
    return (
      <div className="py-16">
        ...
        <div className="text-center text-gray-500">
          ...
          <p className="text-sm mt-2">We're actively onboarding expert mentors. Check back soon!</p>
        </div>
      </div>
    );
  }
    ...
    <section className="py-16">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Connect with our verified expert mentors. Each mentor brings real experience 
          and genuine credentials to guide your wellness journey.
        </p>
        ...
        <div className="flex items-center justify-center space-x-8 mt-6">
          ...
          <div className="text-center">
            <div className={cn("text-2xl font-bold", colorClass.replace('bg-', 'text-'))}>
              {Math.round(mentors.reduce((sum, mentor) => sum + mentor.experience, 0) / mentors.length) || 0}
            </div>
