  ...
  try {
    ...
    testResults.push({
      ...
      foundData:
        ...
        "firstBatch" in scheduleTest.cursor &&
        Array.isArray(scheduleTest.cursor.firstBatch)
          ? scheduleTest.cursor.firstBatch[0]
          : null,
    });
    ...
    if (scheduleData.length > 0) {
      ...
      const stringFound =
        stringTest &&
        typeof stringTest === "object" &&
        "cursor" in stringTest &&
        stringTest.cursor &&
        typeof stringTest.cursor === "object" &&
        "firstBatch" in stringTest.cursor &&
        Array.isArray(stringTest.cursor.firstBatch) &&
        stringTest.cursor.firstBatch.length > 0;
      ...
      try {
        ...
        const objectIdFound =
          objectIdTest &&
          typeof objectIdTest === "object" &&
          "cursor" in objectIdTest &&
          objectIdTest.cursor &&
          typeof objectIdTest.cursor === "object" &&
          "firstBatch" in objectIdTest.cursor &&
          Array.isArray(objectIdTest.cursor.firstBatch) &&
          objectIdTest.cursor.firstBatch.length > 0;
