  ...
  try {
    ...
    const csvRows = [
      ...
      ...filteredUsers.map(user => [
        ...
        user.billingPeriod || '',
        user.subscriptionStartDate ? new Date(user.subscriptionStartDate).toLocaleDateString('en-IN') : '',
        user.subscriptionEndDate ? new Date(user.subscriptionEndDate).toLocaleDateString('en-IN') : '',
