...
import { getUserDetails, getAllUsersDetails, type UserDetails } from "@/lib/userDetails";
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Complete database information for debugging purposes
              </p>
            </div>
          ...
          <Card className="p-6 mb-8 border-l-4 border-l-blue-500">
            ...
            {showRawData && (
              <div className="bg-gray-100 rounded-lg p-4 max-h-64 overflow-auto">
                <pre className="text-sm text-gray-800">{JSON.stringify(currentUser, null, 2)}</pre>
              </div>
            )}
          </Card>
        )}
