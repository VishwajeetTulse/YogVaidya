 ...
 * This script will find users with expired trials and clear their subscription details
 * to make them appear as users with no subscription (as intended)
 */
...
module.exports = { cleanupExpiredTrials, verifyCleanup };
